...
trait ClusterConfig[NODE_ID, CLUSTER_ID] {
  ...
  def asClusterDetailADD(cluster_detail: CLUSTER_DETAIL[NODE_ID, CLUSTER_ID]):
	ClusterDetailADD[NODE_ID, CLUSTER_ID] = 
	  cluster_detail.asInstanceOf[ClusterDetailADD[NODE_ID, CLUSTER_ID]]
		
	def asClusterDetailRMV(cluster_detail: CLUSTER_DETAIL[NODE_ID, CLUSTER_ID]):
	ClusterDetailRMV[NODE_ID, CLUSTER_ID] = 
		cluster_detail.asInstanceOf[ClusterDetailRMV[NODE_ID, CLUSTER_ID]]

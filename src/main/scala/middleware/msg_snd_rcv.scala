...
trait MSGSndRcv[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] {
	def empty_undeliv_msg: UNDELIV_MSG[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]
	...
	UNDELIV_MSG[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = undeliv_msg_class.undeliv_msg
	
	def set_undeliv_msg(undeliv_msg: UNDELIV_MSG[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
	...
	SND_MSG_DATA[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = {
		...
		val msg_vclock = msgOpr.make_msg_vclock(cluster_detail, nodeVCLOCK.make(node_id, tcsb.get_node_vclock(tcsb_class)), crdt_instance)
	...
	def get_undeliv_msg(node_id: NODE_ID,
	                    tnode_id: NODE_ID,
										  ...
										  msg_vclock: MESSAGE[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
	...
	def add_msg_vclock(msg_vclock: MESSAGE[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
	                   msg_list: MSG_LIST[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS])
										(implicit vectorClock: VectorClock[NODE_ID],
											        nodeVCLOCK: NodeVCLOCK[NODE_ID],
										          msgOpr: MSGOperation[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
...
final case object MSGSndRcv extends MSGSndRcv[UNODE_ID, UCLUSTER_ID, PureOpsCRDT, UCRDT_ID, CRDTOps] {	
	val empty_undeliv_msg: 
	  UNDELIV_MSG[UNODE_ID, UCLUSTER_ID, PureOpsCRDT, UCRDT_ID, CRDTOps] = 

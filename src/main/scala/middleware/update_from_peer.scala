...
trait UpdateFromPeer[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] {
	...
	def update(undeliv_msg: UNDELIV_MSG[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
	           crdt_state: CRDT_STATE[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
					   anyId: AnyId[NODE_ID])
 	 					(implicit vectorClock: VectorClock[NODE_ID],
 	 										tcsb: TCSB[NODE_ID, CLUSTER_ID],
  ...
  PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = 
	...
	def update_msg_list(msg_list: MSG_LIST[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
											po_log_class: PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS])
										 (implicit vectorClock: VectorClock[NODE_ID],
															 tcsb: TCSB[NODE_ID, CLUSTER_ID],
															 nodeVCLOCK: NodeVCLOCK[NODE_ID],
	...
	def update_msg_vclock(msg: MESSAGE[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
												po_log_class: PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS])
											 (implicit vectorClock: VectorClock[NODE_ID],
																 tcsb: TCSB[NODE_ID, CLUSTER_ID],
																 nodeVCLOCK: NodeVCLOCK[NODE_ID],
	...
	def update_msg_ops(msg_ops: MSG_OPS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
										 po_log_class: PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS])
										(implicit vectorClock: VectorClock[NODE_ID],
														  tcsb: TCSB[NODE_ID, CLUSTER_ID],
															nodeVCLOCK: NodeVCLOCK[NODE_ID],
															...
															msgLog: MSGLog[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
															pologClass: POLogClass[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
	PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = check_msg(msg_ops, po_log_class) match {
		case NXTMSG => update_next_msg_ops(msg_ops, po_log_class)
		case OOOMSG => update_pending_msg_ops(msg_ops, po_log_class)
		case _      => po_log_class
	}

	def update_next_msg_ops(msg_ops: MSG_OPS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
												  po_log_class: PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS])
											   (implicit vectorClock: VectorClock[NODE_ID],
																   tcsb: TCSB[NODE_ID, CLUSTER_ID],
																   nodeVCLOCK: NodeVCLOCK[NODE_ID],
	...
	def update_pending_msg_ops(msg_ops: MSG_OPS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
												     po_log_class: PO_LOG_CLASS[NODE_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS])
											      (implicit vectorClock: VectorClock[NODE_ID],
																      tcsb: TCSB[NODE_ID, CLUSTER_ID],
																      nodeVCLOCK: NodeVCLOCK[NODE_ID],

...
trait POLogClass[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] {
	...
	def get_tcsb_class(po_log_class: PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
	TCSB_CLASS[NODE_ID] = po_log_class.tcsb_class 

	def get_msg_log(po_log_class: PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
	MSG_LOG[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = po_log_class.msg_log 

	def get_crdt_type(po_log_class: PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
	CRDT_TYPE = po_log_class.crdt_type 

	def get_crdt_data(po_log_class: PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
  ...
  def set_tcsb_class(tcsb_class: TCSB_CLASS[NODE_ID],
	...
	PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = po_log_class.copy(tcsb_class = tcsb_class)						 

  def set_msg_log(msg_log: MSG_LOG[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS],
	                po_log_class: PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
	PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = po_log_class.copy(msg_log = msg_log)						 

  def set_crdt_data(crdt_data: Any,
	                  po_log_class: PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS]):
	PO_LOG_CLASS[NODE_ID, CLUSTER_ID, CRDT_TYPE, CRDT_ID, CRDT_OPS] = po_log_class.copy(crdt_data = crdt_data)						 
